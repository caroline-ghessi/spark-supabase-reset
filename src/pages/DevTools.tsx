    ...
    <MainLayout>
      <div className="p-6 space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Ferramentas de Desenvolvimento</h1>
              ...
              <CardContent>
                <div className="space-y-2 font-mono text-sm">
                  <div className="p-2 bg-green-50 border border-green-200 rounded">
                    <span className="text-green-600">[INFO]</span> Sistema iniciado com sucesso
                  </div>
                  <div className="p-2 bg-blue-50 border border-blue-200 rounded">
                    <span className="text-blue-600">[DEBUG]</span> Conexão com Supabase estabelecida
                  </div>
                  <div className="p-2 bg-yellow-50 border border-yellow-200 rounded">
                    <span className="text-yellow-600">[WARN]</span> Configuração Whapi pendente
                  </div>
                </div>
              </CardContent>
            </Card>
